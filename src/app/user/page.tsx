...
const UserDashboard = () => {
    return (
        <div className=' bg-hero-cover bg-no-repeat bg-cover w-screen h-screen overflow-x-hidden ' >
            <div className='flex justify-between px-10 py-3'>
                <Image src={logo} alt="Logo" className=" h-6 sm:h-[50px] " ></Image>
            ...
            <div className='flex flex-col items-center relative '>
                <Image src={heroImage} alt='hero image' height={450}></Image>
                <div className=' flex gap-3 items-start sm:w-[50vw] absolute top-[60%] '>
                    <Input placeholder="Futsal near me" />
                    <Button className="bg-[#08985A] hover:bg-[#14D045] hidden sm:block" >
                        Search
                    </Button>
                </div>

            </div>
            <div className='relative flex flex-col items-center mt-14 gap-14 ' >
                <div className='flex justify-around w-[70%] h-[22vh] items-center'>
                    <div className='rounded-[100%] bg-[#20C980] flex flex-col items-center justify-center gap-1 cursor-pointer hover:-translate-y-3 duration-500 hover:bg-[#08985A] h-[80px] w-[80px] sm:h-[130px] sm:w-[130px]'>
                        <RiTeamFill className=' text-md sm:text-lg text-gray-200 ' />
                        <span className='text-md sm:text-lg text-gray-200  '>
                            Team
                        </span>
                    </div>
                    <div className='rounded-[100%] self-end bg-[#20C980] flex flex-col items-center justify-center gap-1 cursor-pointer hover:-translate-y-3 duration-500 hover:bg-[#08985A]
                    h-[80px] w-[80px] sm:h-[130px] sm:w-[130px]' >
                        <RiUserFill className='text-md sm:text-lg  text-gray-200 ' />
                        <span className='text-md sm:text-lg  text-gray-200 '>
                            Profile
                        </span>
                    </div>
